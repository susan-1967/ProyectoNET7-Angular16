...
import { IResponseConcert } from '../../services/producto/producto-api-model.interface';
...
export class EventTableComponent implements OnInit, AfterViewInit {
	...
	private readonly _productoApiService = inject(ProductoApiService);
	...
	private _loadConcerts(): void {
		this._productoApiService.getListProductos(1, 50).subscribe((response) => {
