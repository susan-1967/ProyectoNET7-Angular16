...
const routes: Routes = [
	...
	},
	{
		...
		loadChildren: () => import('./pages/login-page/login-page.module').then((m) => m.LoginPageModule) //LAZY LOADING TRADICIONAL
	},
	{
		path: PATHS_AUTH_PAGES.registerPage.onlyPath,
		title: 'Registro de usuario',
		loadComponent: () => import('./pages/register-page/register-page.component') //LAZY LOADING MODERNO
	},
	{
